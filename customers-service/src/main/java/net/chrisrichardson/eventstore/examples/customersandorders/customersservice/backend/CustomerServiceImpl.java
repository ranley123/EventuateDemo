...
public class CustomerServiceImpl implements CustomerService {
  ...
  @Override
  public EntityWithIdAndVersion<Customer> updateCustomer(String customerId, String name, Money creditLimit) {
    return customerRepository.update(customerId, new UpdateCustomerCommand(name, creditLimit));
  }
