...
import net.chrisrichardson.eventstore.examples.customersandorders.customerscommon.*;
...
public class CustomerController {
  ...
  public UpdateCustomerResponse updateCustomer(@PathVariable String customerId, @RequestBody UpdateCustomerRequest updateCustomerRequest){
    EntityWithIdAndVersion<Customer> ewidv;
    try {
      ewidv = customerService.updateCustomer(customerId, updateCustomerRequest.getName(), updateCustomerRequest.getCreditLimit());
    } catch (EntityNotFoundException e) {
      return new UpdateCustomerResponse();
    }
    return new UpdateCustomerResponse(customerId);
